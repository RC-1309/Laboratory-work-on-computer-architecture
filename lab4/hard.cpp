...
void solve(int num_of_treads, int pos) {
    ...
    cout << "Average time: " << sum_time / (double)num_of_starts * 1000 << " ms\n";
}
...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        cerr << "Invalid number of treads: " << argv[1];
    }
    try {
    ...
    if (num_of_colors != 255) {
        cerr << "Incorrect number of colors";
        return 0;
    }
    n = h * w;
